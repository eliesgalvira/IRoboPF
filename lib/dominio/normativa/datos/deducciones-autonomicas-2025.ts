...
export const CATALOGO_DEDUCCIONES_AUTONOMICAS_2025 = parametroNormativo({
  ...
  valor: {
    andalucia: {
      ...
      deducciones: [
        ...deduccionesCatalogadasFaltantes("andalucia"),
    ...
    aragon: {
      ...
      deducciones: [
        ...deduccionesCatalogadasFaltantes("aragon"),
    ...
    asturias: {
      ...
      deducciones: [
        ...deduccionesCatalogadasFaltantes("asturias"),
    ...
    "illes-balears": {
      ...
      deducciones: [
        ...deduccionesCatalogadasFaltantes("illes-balears"),
    ...
    canarias: {
      ...
      deducciones: [
        ...deduccionesCatalogadasFaltantes("canarias"),
    ...
    cantabria: {
      ...
      deducciones: [
        ...deduccionesCatalogadasFaltantes("cantabria"),
