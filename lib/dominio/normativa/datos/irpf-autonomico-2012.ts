...
const fuenteAeatEscalasAutonomicas2012 = {
  titulo:
    "AEAT Manual práctico Renta 2012. Gravamen autonómico de la base liquidable general",
...
export const NORMATIVA_PRE_REFORMA_2015_IRPF_2012 = {
  ...
  medidasPosterioresNoExistentes: [
    ...
    "No existe la regla 2013-2014 que integra en base general las ganancias por transmision con permanencia de un año o menos.",
  ],
