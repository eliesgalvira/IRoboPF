...
export type EscalaAutonomicaIrpf2017 = EscalaAutonomicaIrpf2025

export const TRAMOS_IRPF_ESTATAL_GENERAL_2017: TramosIrpf = [
...
const AEAT_MANUAL_RENTA_2017_PDF =
  "https://sede.agenciatributaria.gob.es/static_files/Sede/Biblioteca/Manual/Practicos/IRPF/IRPF-2017/ManualRentaPatrimonio2017_es_es.pdf"
...
const escala2017 = ({
  fuente = fuenteAeatEscalasAutonomicas2017,
  ...escala
}: Omit<EscalaAutonomicaIrpf2017, "fuente"> & {
  readonly fuente?: EscalaAutonomicaIrpf2017["fuente"]
}): EscalaAutonomicaIrpf2017 => ({
  ...escala,
  fuente,
})

const reutilizarEscala2025ConFuente2017 = (
...
export const ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025 = {
  "simulada-estatal": escala2017({
  ...
  "comunitat-valenciana": escala2017({
...
} satisfies Partial<Record<ComunidadAutonoma, EscalaAutonomicaIrpf2017>>

export const ESCALAS_AUTONOMICAS_IRPF_2017: Readonly<
  Record<ComunidadAutonoma, EscalaAutonomicaIrpf2017>
> = {
  "simulada-estatal":
    ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025["simulada-estatal"],
  andalucia: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.andalucia,
  aragon: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.aragon,
  asturias: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.asturias,
  "illes-balears":
    ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025["illes-balears"],
  canarias: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.canarias,
  cantabria: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.cantabria,
  "castilla-la-mancha": reutilizarEscala2025ConFuente2017(
    ESCALAS_AUTONOMICAS_IRPF_2025["castilla-la-mancha"]
  ),
  "castilla-y-leon":
    ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025["castilla-y-leon"],
  catalunya: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.catalunya,
  extremadura: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.extremadura,
  galicia: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.galicia,
  madrid: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.madrid,
  murcia: ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025.murcia,
  "la-rioja": ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025["la-rioja"],
  "comunitat-valenciana":
    ESCALAS_AUTONOMICAS_IRPF_2017_DISTINTAS_DE_2025["comunitat-valenciana"],
  ceuta: reutilizarEscala2025ConFuente2017(ESCALAS_AUTONOMICAS_IRPF_2025.ceuta),
  melilla: reutilizarEscala2025ConFuente2017(
    ESCALAS_AUTONOMICAS_IRPF_2025.melilla
  ),
}

export const obtenerEscalaAutonomicaIrpf2017 = (
  comunidadAutonoma: ComunidadAutonoma
): EscalaAutonomicaIrpf2017 => ESCALAS_AUTONOMICAS_IRPF_2017[comunidadAutonoma]
