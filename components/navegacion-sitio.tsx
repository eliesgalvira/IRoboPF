    ...
    <nav className="relative text-sm tracking-[0.28em] text-[var(--ink)]/80 uppercase">
      <div className="hidden items-center justify-between gap-x-6 gap-y-2 md:flex">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 border-b border-transparent leading-none transition hover:border-current/60"
          rel="noreferrer"
          target="_blank"
        >
          <IconoGitHub />
          ...
          <div className="min-h-0 overflow-hidden">
            <div className="grid divide-y-2 divide-[var(--rule)]">
              ...
              <a
                ...
                tabIndex={menuMovilAbierto ? 0 : -1}
                onClick={cerrarMenuMovil}
                className="inline-flex items-center gap-3 px-4 py-4 leading-none text-[var(--ink)] transition-colors hover:bg-[var(--mark)] focus-visible:bg-[var(--mark)] focus-visible:outline-none"
              >
                <IconoGitHub />
                GitHub
              </a>
